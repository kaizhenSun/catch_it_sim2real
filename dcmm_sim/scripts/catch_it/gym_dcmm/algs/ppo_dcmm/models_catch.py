...
class ActorCritic(nn.Module):
    def __init__(self, kwargs):
        ...
        self.actor_mlp_c = MLP(units=self.units, input_size=mlp_input_shape)
        ...
        self.mu_c = torch.nn.Linear(out_size, actions_num-4)
        ...
        self.sigma_c = nn.Parameter(
            torch.zeros(actions_num-4, requires_grad=True, dtype=torch.float32), requires_grad=True)
